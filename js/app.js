...
if (document.querySelector('.mainSlider')) {
	...
	for (let index = 0; index < mainSliderImages.length; index++) {
		...
		mass.push(mainSliderImage);
	}
	mass.pop();
	mass.shift();
	for (let index = 0; index < mass.length; index++) {
		const mainSliderImage = mainSliderImages[index].querySelector('img').getAttribute('src');
		mainSliderDotts[index].style.backgroundImage ="url('" + mass[index] +  "')";
...
if (isMobile.any()) {
let menuParents = document.querySelectorAll('.menu-page__parent a');//обращаемся ко всем li  1го уровня
...
let menuParents = document.querySelectorAll('.menu-page__parent');//обращаемся ко всем li  1го уровня
for (let index = 0; index < menuParents.length; index++) {
	const menuParent = menuParents[index];
...
let menuBody = document.querySelector('.menu-page__body');
